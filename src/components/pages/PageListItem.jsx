  ...
  return (
    <li className="page-list-item">
      <NavLink to={`/pages/editor/${page.id}`}>
        ...
        <span className="page-list-item-date-edited">Last Edited: {new Date(page.edited_timestamp).toLocaleDateString()} | {new Date(page.edited_timestamp).toLocaleTimeString([], {timeStyle: 'short'})}</span>
      </NavLink>
